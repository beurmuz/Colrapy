...
Original file is located at
    https://colab.research.google.com/drive/1yLZ0L2clJ3g9gpOOEC4B7oKBneGJjG79
...
model.load_weights(DATA_OUT + model_name +'\weogjts.h5')  # or DATA_OUT + model_name + SAVE_FILE_NM
...
if(predictions > 0.5):
  print("{:.2f} 점 -> 긍정('100'에 가까울수록 강한 긍정)\n".format(predictions * 100))
else:
  print("{:.2f} 점 -> 부정('0'에 가까울수록 강한 부정)\n".format(predictions * 100))
