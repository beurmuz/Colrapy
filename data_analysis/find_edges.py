...
image = cv2.imread('data_img/cosmetic.jpg')                              # 원본 이미지 읽어오기
image_gray = cv2.imread('data_img/cosmetic.jpg', cv2.IMREAD_GRAYSCALE)   # 흑백 이미지로 읽어오기
...
cv2.imwrite('data_result/img_edges.jpg', final[1])                          # 마지막 이미지 저장
